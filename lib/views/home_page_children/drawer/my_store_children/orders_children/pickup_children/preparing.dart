...
class PreparingPickup extends StatefulWidget {
  @override
  _PreparingPickupState createState() => _PreparingPickupState();
}

class _PreparingPickupState extends State<PreparingPickup> {
